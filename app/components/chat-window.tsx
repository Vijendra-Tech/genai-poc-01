...
function ChatWindow({ setOpenChatWindow }: any) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen text-gray-800 z-10 min-w-[30rem] min-h-[40rem] md:min-h-[32rem] lg:min-h-[40rem] fixed bottom-10 -right-1/4 lg:-right-1/5 md:-right-1/5">
